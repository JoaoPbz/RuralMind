...
## 🧩 Descrição geral
O sistema permite o gerenciamento de **clientes, fornecedores, máquinas e vendas**, oferecendo funcionalidades para controle de estoque e geração de relatórios
